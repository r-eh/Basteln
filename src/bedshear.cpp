...
void bedshear::taubed(lexer *p, fdm_nhf * d, ghostcell *pgc, sediment_fdm *s)
{
    ...
    SLICELOOP4
    {
        ...
        k = 0; // ToDo: Check if this is correct
        ...
        if(p->S16==1)
        {
            ...
            // if(p->G3==1)
            // zval = s->bedzh(i,j) + 2.1*p->DZN[KP];
            zval = p->sl_ipol4(d->bed);
            
            if(p->S33==1)
            {
            uvel=p->ccipol1(d->U,xip,yip,zval);
            vvel=p->ccipol2(d->V,xip,yip,zval);
            wvel=p->ccipol3(d->W,xip,yip,zval);

            }
            
            if(p->S33==2)
            {
            uvel=p->ccipol1_a(d->U,xip,yip,zval);
            vvel=p->ccipol2_a(d->V,xip,yip,zval);
            wvel=p->ccipol3_a(d->W,xip,yip,zval);
            }
        ...
        if(p->S16==3)
        {
            ...
            v_d=p->ccipol4(d->VISC,xip,yip,zval);
            v_t=p->ccipol4(d->EV,xip,yip,zval);
            }
            ...
            v_d=p->ccipol4_a(d->VISC,xip,yip,zval);
            v_t=p->ccipol4_a(d->EV,xip,yip,zval);
            }
